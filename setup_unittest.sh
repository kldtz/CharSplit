...
# Note on why we switched back to 0.8.8 instead of 0.8.9
...
#
# For now, simply check 0.8.8, copy the dir-korean/ from *.0.8.9.tar.gz and
...
wget https://s3.amazonaws.com/repo.ebrevia.com/repository/kirke_unit_test.v.0.8.8.tar.gz

tar xvfz kirke_unit_test.v.0.8.8.tar.gz
