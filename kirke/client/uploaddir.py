...
def upload_train_dir(url_st: str, upload_dir: str, candtype: str):
    ...
    print('candtype: %s' % (candtype, ))
    payload = {'candtype': candtype}
...
if __name__ == '__main__':
    ...
    parser.add_argument('--candtype', default='SENTENCE', help='SENTENCE, CURRENCY, DATE, ADDRESS, NUMBER, PERCENT')
    ...
    upload_train_dir(url, args.upload_dir, args.candtype)
