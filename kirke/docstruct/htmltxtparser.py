    ...
    for start, end, line in txtreader.load_normalized_lines_with_offsets(file_name):
        ...
        if start != end:
            if footerutils.classify_line_page_number(line):
                ...
                # print("secheadutils.extract_sechead_v4(ln={}, prv={}, prv_idx={}, iscomb={})" \
                #      .format(line,
                #               prev_nonempty_line,
                #               prev_line_idx,
                #               is_combine_line))
                # print("       sechead_type= {}, prefix_num= {}, sec_head= {}, split_idx= {}" \
                #       .format(sechead_type,
                #               prefix_num,
                #               sec_head,
                #               split_idx))
...
def mark_toc(para_attr_list: List[Tuple[str, List]]) -> Tuple[int, int]:
