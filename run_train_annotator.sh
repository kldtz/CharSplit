...
if [ $# -eq 3 ]; then
    ./main.py --cmd train_span_annotator --provision $1 --candidate_type $2 --docs $3 --work_dir $WORK_DIR --model_dir $MODEL_DIR
elif [ $# -eq 2 ]; then
    ./main.py --cmd train_span_annotator --provision $1 --candidate_type $2 --work_dir $WORK_DIR --model_dir $MODEL_DIR
else
