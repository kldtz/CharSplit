...
def print_paras():
    ...
    for para_i, para_with_attrs in enumerate(paras_with_attrs):
        from_to_lnpos_pair_list, attrs = para_with_attrs
        first_lnpos_pair = from_to_lnpos_pair_list[0]
        last_lnpos_pair = from_to_lnpos_pair_list[-1]

        first_from_lnpos, first_to_lnpos = first_lnpos_pair
        last_from_lnpos, last_to_lnpos = last_lnpos_pair

        para_start = first_to_lnpos.start
        para_end = last_to_lnpos.end

        if para_start == para_end:
            continue

        para_text = nlp_text[para_start:para_end]
        print("\n== para #{} ===============================================".format(para_i+1))
        print(para_text)
